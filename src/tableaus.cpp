...
namespace rk
{
    ...
    const butcher_tableau rkf45 = {
        ...
        {25.f / 216.f, 0.f, 1408.f / 2565.f, 2197.f / 4104.f, -0.2, 0.f},
        6,
        5};
    ...
    const butcher_tableau rkfck45 = {
        ...
        {2825.f / 27648.f, 0.f, 18575.f / 48384.f, 13525.f / 55296.f, 277.f / 14336.f, 0.25},
        6,
        5};
    ...
    const butcher_tableau rkf78 = {
        ...
        {{2.f / 27.f},
         ...
         {2383.f / 4100.f, 0.f, 0.f, -341.f / 164.f, 4496.f / 1025.f, -301.f / 82.f, 2133.f / 4100.f, 45.f / 82.f, 45.f / 164.f, 18.f / 41.f},
         {3.f / 205.f, 0.f, 0.f, 0.f, 0.f, -6.f / 41.f, -3.f / 205.f, -3.f / 41.f, 3.f / 41.f, 6.f / 41.f, 0.f},
         {-1777.f / 4100.f, 0.f, 0.f, -341.f / 164.f, 4496.f / 1025.f, -289.f / 82.f, 2193.f / 4100.f, 51.f / 82.f, 33.f / 164.f, 12.f / 41.f, 0.f, 1.f}},
        {0.f, 0.f, 0.f, 0.f, 0.f, 34.f / 105.f, 9.f / 35.f, 9.f / 35.f, 9.f / 280.f, 9.f / 280.f, 0.f, 41.f / 840.f, 41.f / 840.f},
        {41.f / 840.f, 0.f, 0.f, 0.f, 0.f, 34.f / 105.f, 9.f / 35.f, 9.f / 35.f, 9.f / 280.f, 9.f / 280.f, 41.f / 840.f, 0.f, 0.f},
        13,
        8};
}