...
template <typename T> const butcher_tableau<T> butcher_tableau<T>::rk2 = {{1.f}, {{1.f}}, {0.5, 0.5}, 2, 2};
template <typename T>
...
template <typename T> const butcher_tableau<T> butcher_tableau<T>::rkf12 = {{1}, {{1}}, {0.5, 0.5}, {1.f, 0.f}, 2, 2};
